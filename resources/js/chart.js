document.addEventListener("DOMContentLoaded", function () {
  var pieChartsConfig = [
    ...
    {
      id: "graficoTecnicosPositividade",
      url: "/ajax/os/graficoTecnicosPositividade",
    },
    {
      id: "graficoTecnicosNegatividade",
      url: "/ajax/os/graficoTecnicosNegatividade",
    },
  ...
  var lineChartsConfig = [
    ...
    {
      id: "graficoMediasAno",
      url: "/ajax/graficos/mediaNotasAno",
      yType: "linear",
    },
    {
    ...
    {
      id: "graifcoMassivasHistRegionais",
      url: "/ajax/massivas/graifcoMassivasHistRegionais",
      yType: "logarithmic",
    },
    {
      id: "graficoMassivasHistTipos",
      url: "/ajax/massivas/graficoMassivasHistTipos",
      yType: "logarithmic",
    },
    {
      id: "graficoMassivasHistClientes",
      url: "/ajax/massivas/graficoMassivasHistClientes",
      yType: "logarithmic",
    },
  ];
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (canvas && data && data.labels && data.datasets) {
          ...
          console.error(
            "Dados inválidos ou canvas não encontrado para " + config.id,
          );
        }
      },
      error: function (xhr, status, error) {
    ...
    new Chart(ctx, {
      ...
      options: {
        ...
        onClick: function (evt, elements) {
          ...
          window.location.href = redirectBaseUrl + "?" + params.toString();
        },
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (config.id === "graficoMassivasRegionais") {
          ...
          createBarChart(config.id, data.labels, data.values, config.label);
        }
      },
      error: function (xhr, status, error) {
        console.error("Erro ao obter dados de " + config.url, error);
