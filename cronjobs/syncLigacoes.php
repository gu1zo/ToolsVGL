...
$dataFim = new DateTime('now', new DateTimeZone('America/Sao_Paulo'));

for ($dataConsulta = clone $dataInicio; $dataConsulta <= $dataFim; $dataConsulta->modify('+1 day')) {
...
echo "Ligações sincronizadas de "
